# poke_search
<img width="800" alt="image" src="https://github.com/user-attachments/assets/5a2d16f6-f1a1-40dc-8a86-84eb3fd2081d">

# Installation
You will need Rust 1.93.0 installed. I recommend using [`rustup`](https://rustup.rs/)
```sh
